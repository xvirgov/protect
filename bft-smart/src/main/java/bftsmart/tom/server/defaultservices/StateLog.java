 ...
 * the present. The state associated with the last checkpoint together with all
 * the batches of messages received so far, comprises this replica current state
 * 
 * @author Joao Sousa
 */
public class StateLog {
	...
	/**
	 * Sets the state associated with the last checkpoint, and updates the consensus
	 ...
	 * 
	 * @param lastCheckpointCID
	 *            Consensus ID for the last checkpoint
	 */
	...
	/**
	 * Sets the consensus ID for the last messages batch delivered to the
	 * application
	 * 
	 * @param lastCID
	 *            the consensus ID for the last messages batch delivered to the
	 *            application
	 */
