 ...
 * the Byzantine fault model described in Cachin's 'Yet Another Visit to Paxos'
 * (April 2011)
 */
public class Consensus {
	 ...
	 * 
	 * Important: At this point, the 'decision' parameter is only a placeholder for
	 * the future decision, and should not be delivered to the delivery thread.
	 * 
	 * Use 'isDecided()' to check if the consensus already decided a value.
	 * 
	 * @param manager
	 *            Execution manager for this replica's consensus instances
	 * @param decision
	 ...
	 * @param controller
	 *            The view controller for the replicas
	 * @return The epoch
	 */
	 ...
	 * @param create
	 *            if the epoch is to be created if not existent
	 * @param controller
	 *            The view controller for the replicas
	 * @return The epoch
	 */
	 ...
	 * 
	 * @param ets
	 *            New ETS for this consensus, to advance to the next epoch. It must
	 *            be greater than the current ETS
	 */
	...
	/**
	 * Return the value read from a Byzantine quorum of WRITES that has previously
	 * been stored
	 * 
	 * @return the value read from a Byzantine quorum of WRITES, if such value has
	 ...
	 * 
	 * @param timestamp
	 *            The timestamp to associated to this epoch
	 * @param recManager
	 *            The replica's ServerViewController
	 * @return The epoch
	 */
	 ...
	 *
	 * @param epoch
	 *            The epoch at which a decision was made
	 * @param deliver
