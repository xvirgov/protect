...
public class BNCurve2 {
	...
	/**
	 * Build the standard sextic twist E': y'^2 = x'^3 + b' of the standard BN curve
	 * E: y^2 = x^3 + b.
	 *
	 * @param E given BN curve
	 *
	 * @return the desired curve, or null if E does not have a suitable twist of the
	 *         above form.
	 */
	 ...
	 *         of Applied Cryptography", CRC Press (1997), section 14.6
	 *         (Exponentiation)
	 */
